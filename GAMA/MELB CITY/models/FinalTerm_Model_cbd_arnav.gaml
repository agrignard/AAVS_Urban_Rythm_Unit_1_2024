...
global {
	...
	rgb building_color<-rgb(236,233,232);
	...
	map<rgb,string> legends <- [rgb(231, 111, 81)::"House/Townhouse",rgb(42, 157, 143)::"Office",rgb(244, 162, 97)::"Retail - Shop",rgb(233, 196, 106)::"Retail - Shop",rgb(38, 70, 83)::"Educational/Research", rgb(33, 158, 188)::"Performances, Conferences, Ceremonies"];
...
species building3D {
	...
	aspect base {
		draw shape color:rgb(255,255,255) border:#gray depth:0;
	}
...
experiment cbd_toolkit_virtual type: gui autorun:true virtual:true{	
	...
	output synchronized:true{
		...
		display Screen1 type: 3d axes: false background:background_color virtual:true autosave:false {
			...
			species traffic_network aspect: base visible:show_network transparency:0.8 position:{0,0,exploded_layer? layerfactor*cycle*2 :0.0};
